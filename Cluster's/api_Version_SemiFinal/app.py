...
"""
# Cette fonction permets de d'avoir l'état du patient comme réponse
@app.get('/getStats/{week}/{room}/{medicine}/{condition}')
async def getStats(week:int,room: int,medicine:int,condition:str,q : Optional[int,int,int,str] = None):
    return load_get_Stats(week,room,medicine,condition)
